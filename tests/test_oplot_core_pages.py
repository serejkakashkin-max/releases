...
class CorePageTests(unittest.TestCase):
    ...
    def test_home_uses_shell_and_preserves_route_data_contract(self):
        ...
        self.assertIn("css/oplot_stage9_home.css", text)
        self.assertNotIn("css/oplot_stage9_refinement.css", text)
        ...
        self.assertIn("oplot-core-theme-toggle__icon--dark", text)
        self.assertIn("oplot-core-theme-toggle__icon--light", text)
        ...
        self.assertLess(text.index('id="link-sandbox"'), text.index("data-oplot-theme-toggle"))
        ...
        self.assertNotIn("oplot-home-theme-toggle", home_css)
        shared_css = (PROJECT_ROOT / "static" / "css" / "oplot.css").read_text(encoding="utf-8")
        self.assertIn(".oplot-topbar--core", shared_css)
        self.assertIn(".oplot-core-theme-toggle", shared_css)
