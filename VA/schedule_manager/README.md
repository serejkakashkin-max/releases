...
Если центральный справочник недоступен или identity/order comparison перестал быть точным, VA безопасно возвращается к локальным записям без изменения графиков.
